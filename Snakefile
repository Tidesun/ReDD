...
if config['reference'] == 'genome':
    ...
    checkpoint pre_compute_visualization:
        ...
        shell:
            ...
            python2 scripts/py_gpd2gtf.py igv/annotation.gpd igv/annotation.gtf
            ((grep ^"#" igv/annotation.gtf; grep -v ^"#" igv/annotation.gtf | sort -k1,1V -k4,4n -k5,5n) | bgzip  > igv/annotation.gtf.gz) || true
            tabix -p gff igv/annotation.gtf.gz || true
